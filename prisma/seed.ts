...
async function seed() {
  ...
  const settings = [
    ...
    { key: "heroTextPosition", value: "center", type: "text", category: "hero", label: "Hero Text Position (left/center/right)" },
    { key: "heroCtaColor", value: "#ff9e16", type: "color", category: "hero", label: "Hero CTA Button Color" },
    { key: "heroCtaLink", value: "#contact", type: "text", category: "hero", label: "Hero CTA Button Link" },
    { key: "heroCta2Color", value: "", type: "color", category: "hero", label: "Hero CTA 2 Button Color (empty=outline)" },
    { key: "heroCta2Link", value: "tel:+16107259900", type: "text", category: "hero", label: "Hero CTA 2 Button Link" },
    // Hero Appearance
  ...
  const insurancePages = [
    {
      ...
      tip: "Bundle auto with home insurance and save up to 25% on your premium!", iconColor: "#0033A0", iconBgColor: "#e8edf5", iconName: "Car", order: 0, emoji: "🚗",
    },
    {
      ...
      tip: "Ask about the Claim RateGuard® add-on to keep your rates from increasing after a claim.", iconColor: "#001e60", iconBgColor: "#e0e7f5", iconName: "Home", order: 1, emoji: "🏠",
    },
    {
      ...
      tip: "Term life insurance can be 5-15x more affordable than whole life — perfect for young families!", iconColor: "#c74e10", iconBgColor: "#fef3e8", iconName: "Heart", order: 2, emoji: "❤️",
    },
    {
      ...
      tip: "Renters insurance can cost as little as $15-30/month — less than a streaming subscription!", iconColor: "#0e7490", iconBgColor: "#e6f7fa", iconName: "Building2", order: 3, emoji: "🏢",
    },
    {
      ...
      tip: "Review your condo association's master policy to understand exactly what you need to cover.", iconColor: "#7c3aed", iconBgColor: "#f0e8ff", iconName: "Landmark", order: 4, emoji: "🏛️",
    },
    {
      ...
      tip: "Store your bike in the off-season? Ask about lay-up periods to reduce your premium.", iconColor: "#dc2626", iconBgColor: "#fef2f2", iconName: "Bike", order: 5, emoji: "🏍️",
    },
    {
      ...
      tip: "A Business Owner's Policy (BOP) bundles property and liability coverage at a reduced rate.", iconColor: "#059669", iconBgColor: "#ecfdf5", iconName: "Briefcase", order: 6, emoji: "💼",
    },
    {
      ...
      tip: "Many boat policies include discounts for completing boating safety courses.", iconColor: "#0284c7", iconBgColor: "#e8f4fd", iconName: "Ship", order: 7, emoji: "⛵",
    },
    {
      ...
      tip: "Some homeowners policies offer limited ATV coverage — but a dedicated policy provides full protection.", iconColor: "#65a30d", iconBgColor: "#f0fce4", iconName: "TreePine", order: 8, emoji: "🌲",
    },
    {
      ...
      tip: "There's typically a 30-day waiting period before a new flood policy takes effect — don't wait for storm season!", iconColor: "#0d9488", iconBgColor: "#e6faf8", iconName: "Umbrella", order: 9, emoji: "☔",
    },
    {
      ...
      tip: "Over 14 million Americans were victims of identity theft last year — protect yourself proactively.", iconColor: "#9333ea", iconBgColor: "#faf0ff", iconName: "Fingerprint", order: 10, emoji: "🔐",
    },
    {
      ...
      tip: "Good Hands Rescue® lets you request help with just a tap in the Allstate mobile app.", iconColor: "#ea580c", iconBgColor: "#fff5eb", iconName: "Wrench", order: 11, emoji: "🔧",
    },
  ];
